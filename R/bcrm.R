...
runModelLogisticTwo = function(data = NULL, targetTox = 0.4, inDoses = 1:7, mean = c(2.5,1.5), variance = c(0.84^2,0.134,0.134,0.80^2)) {
  ...
  prior.alpha<-list(4,mean,variance)
  ## Pre-specified probabilities of toxicity
  ## [dose levels 11-15 not specified in the paper, and are for illustration only]
  ## Data from the first 5 cohorts of 18 patients
  if(is.null(data)){
...
#' @export runModelPower
runModelPower = function(data = NULL, targetTox = 0.4, inDoses = 1:7, mean = 1, variance = 0.64) {
